            ...
            <div class="section"> {{-- Start of Section--}}
                ...
                <div class="section-content"> {{-- Start of sectionContent--}}
                    ...
                    <form method="post" action="{{route('product.store')}}" wire:submit.prevent="save">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" name="name" wire:model="pname" class="form-control" placeholder="Product Name" />
                                <label class="float-label">Product Name</label>
                            </div>
                            <div class="col">
                                <input type="text" name="pcode" wire:model="pcode" class="form-control" placeholder="Product code" />
                        ...
                        <div class="row">
                            <div class="col">
                                <textarea name="description" class="form-control" wire:model="pdescription" rows="5" placeholder="Description"></textarea>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control br-select" wire:model="pbrand" name="brand">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control cat-select" wire:model="pcat" name="catID">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control sup-select" wire:model="psup" name="supplierId">
        ...
        <div class="col-md-8">
            <div class="section"> {{-- Start of Section--}}
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col">
                            <input type="text" name="costPrice" wire:model="cprice" class="form-control" placeholder="Cost Price" />
                            <label class="float-label">Cost Price</label>
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" wire:model="sprice" name="sellingPrice" placeholder="Selling Price">
                            <label class="float-label">Selling Price</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input type="text" name="discount" wire:model="pdiscount" class="form-control" placeholder="Discount" />
            ...
            <div class="section"> {{-- Start of Section--}}
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col">
                            <div class="form-group inv-col">
                                ...
                                <select class="form-control inv-select" wire:model="pinv">
                    ...
                    <div class="row qty-row">
                        <div class="col">
                            <input type="text" name="Qty" wire:model="pqty" class="form-control" placeholder="Quantity" />
                            <label class="float-label">Quantity</label>
                        </div>


                        <div class="col">
                            <input type="text" name="reorder_level" wire:model="prqty" class="form-control" placeholder="Reorder Quantity" />
                                ...
                                <tr>
                                    ...
                                    <td class="price-td">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="price-variant" wire:model="vprice.{{ $i }}" class="form-control price-var" placeholder="0.00" value="{{ $sprice }}"/>
                                        </div>
                                    </td>
                                    <td class="qty-td">
                                ...
                                <tr>
                                    ...
                                    <td class="price-td">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="pricevariant{{ $i }}" wire:model="vprice.{{ $key }}" class="form-control price-var"  value="{{ $sprice }}"  placeholder="0.00" />
                                        </div>
                                    </td>
                                    <td class="qty-td">
                                        <div class="input-group number-spinner">
                                ...
                                <tr>
                                    ...
                                    <td class="price-td">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="price-variant" wire:model="vprice.{{ $key }}"  class="form-control price-var" value="{{ $sprice }}" placeholder="0.00" />
                                        </div>
                                    </td>
                                    <td class="qty-td">
                                        <div class="input-group number-spinner">
