<div>
    <div class="section-content">
        <form action="{{ route('reports.export-monthly-sales-summary') }}" target="_blank" method="POST">
            @csrf
            <table wire:loading.remove id="data_table" class="table table-striped table-borderless">
                ...
                <div class="float-right pr-3 pt-1">
                    <input wire:model="date" class="form-control" type="month" name="date" id="date_input">
                </div>
