...
<div class="pg-heading">
    ...
    <div class="pg-title">Supplier Payment Report</div>
</div>

<div class="section">

    <div class="section-content">
        <form action="{{ route('reports.export-supplier-payment') }}" target="_blank" method="POST">
            @csrf
            ...
            <table id="data_table" class="table table-striped table-borderless table-hover all-table">
                ...
                <tbody>
                    @foreach($supplier_pays as $supplier_pay)
                        <tr>
                            <td>{{ $supplier_pay->name }}</td>
                            <td>{{ $supplier_pay->company_name }}</td>
                            <td class="text-capitalize">{{ $supplier_pay->paymentType }}</td>
                            <td class="text-right">{{ $supplier_pay->amount }}</td>
                            <td>{{ $supplier_pay->updated_at }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
