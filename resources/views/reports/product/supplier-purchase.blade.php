...
<div class="pg-heading">
    ...
    <div class="pg-title">Supplier Purchase Report</div>
</div>

<div class="section">

    <div class="section-content">
        <form action="{{ route('reports.export-supplier-purchase') }}" target="_blank" method="POST">
            @csrf
            ...
            <table id="data_table" class="table table-striped table-borderless table-hover all-table">
                ...
                <tbody>
                    @foreach($supplier_purchases as $supplier_purchase)
                        <tr>
                            <td>{{ $supplier_purchase->name }}</td>
                            <td>{{ $supplier_purchase->company_name }}</td>
                            <td class="text-right">{{ $supplier_purchase->total }}</td>
                            <td>{{ $supplier_purchase->note }}</td>
                            <td>{{ $supplier_purchase->expectedDate }}</td>
                            <td>{{ $supplier_purchase->updated_at }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
