            ...
            <tbody>
                @foreach($sales_products as $sales_product)
                    <tr>
                        ...
                        <td style="text-align: right">{{ $sales_product->sales_sum }}</td>
                        <td style="text-align: right">{{ $sales_product->cost_sum }}</td>
                        <td style="text-align: right">{{ $sales_product->gp }}</td>
                        <td style="text-align: right">{{ $sales_product->np }}</td>
                        <td style="text-align: right">{{ number_format($sales_product->gp_margin, 2, '.', ',') . "%" }}</td>
                        <td style="text-align: right">{{ $sales_product->sale->taxes }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
