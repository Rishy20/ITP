            ...
            <tbody>
                @foreach($sales_categories as $sales_category)
                    <tr>
                        ...
                        <td style="text-align: right">{{ $sales_category->qty_sum }}</td>
                        <td style="text-align: right">{{ $sales_category->sales_sum + $sales_category->sale->taxes }}</td>
                        <td style="text-align: right">{{ $sales_category->sales_sum }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
