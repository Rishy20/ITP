...
<div class="section"> {{-- Start of Section--}}
  ...
  <div class="section-content" > {{-- Start of sectionContent--}}
    ...
    <form method="post" class="needs-validation" action="{{ route('salaryPayment.store') }}" novalidate >
              ...
              <div class="row">
                  <div class="col">
                      <input type="text" class="form-control" name="staffID" placeholder="staffID" required>
                  ...
                  <div class="col">
                    <input type="text" id="vendorId" name="amount" class="form-control" placeholder="Amount" required/>
