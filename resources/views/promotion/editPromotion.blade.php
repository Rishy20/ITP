    ...
    <div class="col-md-9">
        ...
        <div class="section"> {{-- Start of Section--}}
            ...
            <div class="section-content"> {{-- Start of sectionContent--}}
                ...
                <form method="post" class="needs-validation" action="{{route('promotion.update',$prms->id)}}" novalidate>
                    @method('patch')
                    @csrf

                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" name="promotionname" id="promotionname" value="{{$prms->promotionname }}" placeholder="Promotion Name" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="descriptionEdit" class="pos-sub-txtArea" rows=5>{{$prms->description}}</textarea>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col">
                        <input type="date" class="form-control" name="startdate" value="{{date('Y-m-d',strtotime($prms->startdate))}}" id="startdate" placeholder="Start Date" required>
                        ...
                        <div class="col">
                            <input type="date" class="form-control" value="{{date('Y-m-d',strtotime($prms->enddate))}}" name="enddate" id="enddate" placeholder="End Date" required>
            ...
            <div class="section-content"> {{-- Start of sectionContent--}}
                ...
                {{-- <form method="post" class="needs-validation" action="{{route('promotion.store')}}" novalidate>
                    ...
                    <div id="amount">
                        ...
                        <div class="row " id="amount">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="amount" class="form-control" placeholder="0.00" id="cashamount">
                            </div>
                    ...
                    <div id="percents">
                        ...
                        <div class="row ">
                            <div class="input-group mb-3">
                                <input type="text" name="percentage" class="form-control" placeholder="0" id="percentAmount">
...
<script>
    ...
    $("document").ready(function() {
        ...
        var promotions = <?php echo json_encode($prms); ?>;
        // console.log(promotions['discounttype']);
        $("#discountSel").val(promotions['discounttype']);

        if(promotions['discounttype'] == 'cash'){
            $("#amount").show();
            $("#percents").hide();
            $('#cashamount').val(promotions['discount']);

        }else{
            $("#percents").show();
            $("#amount").hide();
            $('#percentAmount').val(promotions['discount']);
        }
        $("#typeSel").val(promotions['promotiontype']);

        var products = <?php echo json_encode($promo); ?>;
        products.forEach(function(index,value,array){
            var pid = array[value]['pid'];
            var vid = array[value]['vid'];
            addProduct(pid,vid);
        });
